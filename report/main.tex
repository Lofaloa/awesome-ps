...
\input{./report/sections/proc_file_system}
\input{./report/sections/process_selection_module}
\input{./report/sections/proc_reader_module}
\input{./report/sections/user_interaction_module}
\end{document}
